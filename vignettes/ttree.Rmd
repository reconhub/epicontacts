...
of symptom onset, age, sex and outcome for each case. The contacts dataframe specifies the infector and infectee in the `from` and `to` columns, respectively, as well as the contact status (suspected or confirmed), duration of contact and date of first contact.
...
as a transmission tree using the `method` argument, and indicate which column in our 
linelistp should be used for the x-axis (in this case, the date of symptom onset).
