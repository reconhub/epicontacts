...
```{r, eval=TRUE}   
  cases <- c("SK_14","SK_145")              # Select  one or more record(s)
  x_subset_N <- subset_clusters_by_id(x, cases)  # connected component which includes the selected cases
...
* identify case by label: mouse over 
