...
full list of options use `?vis_epicontacts()`. Alternatively, the `method` used
...
The `get_clusters()` function returns an augmented `epicontacts` object that
includes two extra features in the line list: *cluster_member* and
*cluster_size*. In this context, a 'cluster' corresponds to groups of connected
