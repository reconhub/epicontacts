...
#     ## We read in the epi_contacts object, which contains the two dataframes,
#     ## the 'linelist' and the 'contacts' dataframes. This function converts
#     ## the 'contacts' dataframe into an igraph object.  It extracts
#     ## information for the igraph vertices from the corresponding 'linelist'
#     ## dataframe (if they are present), and assigns them as vertx attributes.
#
...
#
#     ### attrs: the epi_contacts linelist, which serves as the source of the
#     attributes attrs <- x$linelist
#
...
#
#     ### assigning the attributes to the igraph igraph::vertex_attr(net) <-
#     attrs_list # {{figure out if I should keep the "id" as an attr or not?}}
